...
```{r , fig.height = 8, fig.width = 6, fig.align = "center",message = FALSE}

ELJAlogistic(var = 'diabetes',data = PimaIndiansDiabetes,manplot = T,Bonferroni = T,FDR = T, 
             nbvalmanplot = 30, manplotsign = F)
results
```
